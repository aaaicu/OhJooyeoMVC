<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div style="width: 270px;">
		<span>
		<select id="selectWorshipId" class = "custom-select" name="selectWorshipId">
		</select>
		</span>
		<span>
		<input type = "button" class="btn btn-primary btn-sm" value = "삭제" id = "deleteWorship">
		</span>
	</div>
	<br/>
	<ul id="worshipInfo">
			...
			<table>
				<tr>
					...
					<input type='hidden' name='worshipUpdateYN' value ='0'>
					 <h5 class = "text-muted">예배 일자 </h5>
					</td>
					<td><input type="text" class ='chkTarget form-control form-control-sm' name="worshipDate">
					</td>
				</tr>
				<tr>
					<td> <h5 class = "text-muted">사회자 </h5></td>
	...
	<div id = "renderArea">
		<div id = "orderArea">	
			<form id = "orderForm">
			<h2>순서 <input type = "button" name = "order" class="addHtml btn btn-info btn-sm"  value = "추가"></h2>
			<ul id="orderList"></ul>
			</form>
		</div>
		<br/>
		<div id = "adArea">	
			<form id = "adForm">
			<h2>광고 <input type = "button" name = "ad" class = "addHtml btn btn-info btn-sm" value = "광고추가"></h2>
			<ul id="adList"></ul>
			</form>
		</div>
	</div>
